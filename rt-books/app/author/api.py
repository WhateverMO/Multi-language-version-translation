...
def author_register():
    if request.method == 'POST':
        ...
        author_id = add_author(authores(author_name=author_name, password=password))
...
def author_add_books_index():
    if request.method == 'POST':
        try:
            ...
            book_id = add_book(booklib(author_id=author_id, name=name, lang_id=lang_id, bc_id=bc_id, desc=book_desc))
        except Exception as e:
            print(e)
...
# 搜索
@author.route('/book/search/<int:book_id>', methods=['GET'])

...
if __name__ == '__main__':
    ...
    add_book_class(bookclass(bookclass_id=1,class_name='news'))
    add_book_class(bookclass(bookclass_id=2,class_name='novel'))
    add_book_class(bookclass(bookclass_id=3,class_name='history'))
    add_language(languages(lang_id=1,lang_name='zh_CN'))
    add_language(languages(lang_id=2,lang_name='english'))
    add_language(languages(lang_id=3,lang_name='zh_TW'))
